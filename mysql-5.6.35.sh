...
if [ `uname -m` == "x86_64" ];then
  if [ ! -f mysql-5.6.35-linux-glibc2.5-x86_64.tar.gz ];then
  wget http://zy-res.oss-cn-hangzhou.aliyuncs.com/mysql/mysql-5.6.35-linux-glibc2.5-x86_64.tar.gz
  fi
  mv mysql-5.6.35-linux-glibc2.5-x86_64.tar.gz /alidata/install
  cd /alidata/install
  tar -xzvf mysql-5.6.35-linux-glibc2.5-x86_64.tar.gz
  mv mysql-5.6.35-linux-glibc2.5-x86_64/* /alidata/mysql
else
  rm -rf mysql-5.6.35-linux-glibc2.5-i686
  if [ ! -f mysql-5.6.35-linux-glibc2.5-i686.tar.gz ];then
  wget http://zy-res.oss-cn-hangzhou.aliyuncs.com/mysql/mysql-5.6.35-linux-glibc2.5-i686.tar.gz
  fi
  tar -xzvf mysql-5.6.35-linux-glibc2.5-i686.tar.gz
  mv mysql-5.6.35-linux-glibc2.5-i686/* /alidata/mysql
